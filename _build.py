  ...
  <section class="section-pad bg-offwhite">
    <div class="container">
      ...
      <div class="gallery-carousel reveal">
        <figure class="gallery-photo"><img src="assets/img/gallery/01-deck-overview.jpg" alt="Illuminated AmeriDex dock and walkway at night with lake view" loading="lazy"></figure>
        <figure class="gallery-photo"><img src="assets/img/gallery/02-deck-detail.jpg" alt="Aerial view of an AmeriDex elevated lakeside deck" loading="lazy"></figure>
        <figure class="gallery-photo"><img src="assets/img/gallery/03-deck-side.jpg" alt="Side view of an elevated AmeriDex boathouse deck with lower-level living space" loading="lazy"></figure>
        <figure class="gallery-photo"><img src="assets/img/gallery/04-deck-corner.jpg" alt="Comfortable patio seating beneath an AmeriDex deck" loading="lazy"></figure>
        <figure class="gallery-photo"><img src="assets/img/gallery/05-deck-installed.jpg" alt="Multi-level AmeriDex deck showing the dry, finished underside above a covered patio" loading="lazy"></figure>
        <figure class="gallery-photo"><img src="assets/img/gallery/06-deck-finished.jpg" alt="Finished AmeriDex deck with outdoor kitchen and dining area" loading="lazy"></figure>
        <figure class="gallery-photo"><img src="assets/img/gallery/07-deck-railing.jpg" alt="Family relaxing on a paver patio under an AmeriDex deck" loading="lazy"></figure>
        <figure class="gallery-photo"><img src="assets/img/gallery/08-deck-stairs.jpg" alt="Two-story home with an AmeriDex deck and finished, lit under-deck living space below" loading="lazy"></figure>
      </div>
